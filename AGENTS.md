...
- `Phase 11. Object templates and equipment catalog` and `Phase 12. Backup, snapshots, and change history` are approved; `Phase 11A. Equipment catalog model` passed manual review, and `Phase 11B. Equipment catalog UI` is committed/pushed on `to`.
