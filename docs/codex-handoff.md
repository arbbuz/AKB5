...
- Следующий практический шаг только один: Windows smoke-check формы с реальным открытием/сохранением/Excel import-export и визуальной проверкой photo preview.
...
- `/Users/home/.dotnet/dotnet build asutpKB.csproj --configuration Release`
