...
- Treat `Phase 7E.2` as the active local implementation slice: Excel export/import of the yearly placement source
...
- Manually review the verified `phase7e-year-schedule-source-exchange` build, then commit/push if accepted
- After review, decide whether to:
  - accept `Phase 7E` at the Excel source-exchange layer
