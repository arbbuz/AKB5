...
Правильный сценарий редактирования: менять только бизнес-значения (`LevelName`, `WorkshopName`, `NodeName`, `Description`, `Location`, `PhotoPath`, `IpAddress`, `SchemaLink`, выбор текущего цеха), а технические колонки не трогать.
